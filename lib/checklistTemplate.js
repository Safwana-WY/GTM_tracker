    ...
    sections: [
      {
        ...
        items: [
          { key: "wp-0", when: "T-10", owner: "Melwyn", text: "readme.txt drafted/updated — description, FAQ, changelog, and \"tested up to\" WordPress version. This is the plugin's main SEO surface on WordPress.org" },
          { key: "wp-1", when: "T-10", owner: "Melwyn", text: "Plugin banner, icon, and screenshot assets sized to WordPress.org's spec" },
