    ...
    sections: [
      {
        ...
        items: [
          ...
          { key: "timeline-7", when: "T-1", owner: "Sidharth", text: "Video walkthrough recorded and edited (major releases only) — short screen-capture demo, script leads with the user benefit, not a feature tour" },
