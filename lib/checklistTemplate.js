...
const TIERS = {
    ...
    sections: [
      {
        ...
        items: [
          ...
          { key: "timeline-7", when: "T-1", owner: "Sidharth", text: "Video walkthrough recorded and edited — short screen-capture demo, script leads with the user benefit, not a feature tour" },
          ...
          { key: "timeline-11", when: "Day 0 (or T+1 if not ready)", owner: "Sidharth / Melwyn", text: "Video walkthrough embedded on the product/blog page and posted natively to LinkedIn — tracked separately since editing usually runs behind the rest of Day 0" },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { key: "minor-5", owner: "Sidharth", text: "Short video walkthrough recorded and edited, embedded on the product page and posted natively to LinkedIn" }
        ]
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { key: "product-17", when: "T-1", owner: "Sidharth", text: "Product video walkthrough recorded and edited, ready to embed on Day 0" }
        ]
      },
      {
        title: "Day 0",
  ...
  5: {
    label: "WordPress Plugin Launch",
    banner:
      "A new WordPress plugin or a major new version of an existing one (Accessibility Toolkit, Alt Text Generator AI, WebYes WP Accessibility Checker, AccessYes). Adds WordPress.org repo requirements on top of the standard release checklist. Marketing lead time: 10+ working days — WordPress.org's own review can take several days by itself.",
    sections: [
      {
        title: "WordPress.org repo (T-10 to T-3)",
        items: [
          { key: "wp-0", when: "T-10", owner: "Sidharth", text: "readme.txt drafted/updated — description, FAQ, changelog, and \"tested up to\" WordPress version. This is the plugin's main SEO surface on WordPress.org" },
          { key: "wp-1", when: "T-10", owner: "Naseem", text: "Plugin banner, icon, and screenshot assets sized to WordPress.org's spec" },
          { key: "wp-2", when: "T-7", owner: "Shamnas", text: "New plugin submitted to WordPress.org for review, or new version packaged and ready to push (updates to an existing plugin)" },
          { key: "wp-3", when: "T-3", owner: "Sidharth", text: "Confirm the WordPress.org listing is live/updated and \"tested up to\" version is current" }
        ]
      },
      {
        title: "Standard launch checklist (T-7 to Day 0)",
        items: [
          { key: "wp-4", when: "T-7", owner: "Melwyn", text: "Launch or update blog post drafted" },
          { key: "wp-5", when: "T-5", owner: "Melwyn", text: "Plugin's product page copy on webyes.io updated" },
          { key: "wp-6", when: "T-3", owner: "Melwyn", text: "Social post plan (LinkedIn, and relevant WordPress community forums/groups)" },
          { key: "wp-7", when: "T-3", owner: "Sidharth", text: "Changelog entry and docs updated" },
          { key: "wp-8", when: "T-1", owner: "Sidharth", text: "Video walkthrough recorded and edited" },
          { key: "wp-9", when: "T-1", owner: "Naseem", text: "Final screenshots delivered" }
        ]
      },
      {
        title: "Day 0",
        items: [
          { key: "wp-10", when: "Day 0", owner: "All / Safwana", text: "Plugin live on WordPress.org, product page updated, blog post published, changelog posted, video embedded, social posts out. Safwana confirms each" }
        ]
      },
      {
        title: "T+7 review",
        items: [
          { key: "wp-11", owner: "Safwana", text: "Sign-ups/installs attributable to the plugin, not blended into overall WebYes numbers" },
          { key: "wp-12", owner: "Safwana", text: "WordPress.org listing stats: active installs, rating, and reviews" },
          { key: "wp-13", owner: "Safwana", text: "Traffic to the plugin's product page (GSC + web analytics)" },
          { key: "wp-14", owner: "Safwana", text: "Video walkthrough views and watch-through rate" },
          { key: "wp-15", owner: "Safwana", text: "Log what worked, what didn't, and the decision on next iteration" }
        ]
      }
    ]
  }
