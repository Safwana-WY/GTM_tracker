    ...
    sections: [
      {
        ...
        items: [
          ...
          { key: "product-2", when: "T-21", owner: "Melwyn", text: "Draft the standalone product page or mini-site copy (or a dedicated section on WebYes.com if no separate domain)" },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { key: "wp-5", when: "T-5", owner: "Melwyn", text: "Plugin's product page copy on WebYes.com updated" },
